...
import {
  ...
  TextField, Alert, Table, TableBody, TableCell, TableContainer,
...
const Payments = ()=> {
  ...
  const handlePayment = async () => {
    if (!selectedService || !amount) {
      setError('Please select a service and enter an amount.');
      return;
    }
  ...
  const getStatusColor = (status) => {
    switch (status.toLowerCase()) {
      case 'completed': return { color: '#2e7d32', bgcolor: '#e8f5e9' };
      case 'pending': return { color: '#ed6c02', bgcolor: '#fff3e0' };
      case 'failed': return { color: '#d32f2f', bgcolor: '#fdecea' };
      default: return { color: '#1a73e8', bgcolor: '#e8f0fe' };
    }
  };
                  ...
                  <TableRow key={payment._id}>
                    ...
                    <TableCell>
                      <Chip
                        ...
                        size="small"
                        sx={{ color: statusColor.color, bgcolor: statusColor.bgcolor }}
                      />
                    </TableCell>
                  </TableRow>
                );
